node {
  ...
  withSonarQubeEnv('sq19') {
	...
	sh(returnStatus: true, script: "mvn clean install sonar:sonar -Dsonar.host.url=http://bgsovm00017.corp.polygran.de:9000 -Dsonar.login=sqp_6a4d29cc0fefa465dbe459ea8f9792e922a23ed7 -Dsonar.analysis.buildNumber=${BUILD_NUMBER} -Dsonar.analysis.jobName=${JOB_NAME}")
}
  }
}
